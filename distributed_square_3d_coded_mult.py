...
if rank == size-1:               # This is the master's task
    ...
    print(rank,place_to_rank)
    my_row = np.fromfunction(lambda i  :  rank**i, (fault_tolerance,),dtype=float)
    acummalator = result
    # print("my row " , my_row)
    print("first_time", my_place, rank, my_row, acummalator)
    for i in range(fault_tolerance):
        if i < my_place:
            ...
            # print(i, my_place, new_row, new_mat)
        if i == my_place:
            ...
            for j in range(fault_tolerance-my_place-1):
                ...
                req.wait()
        print(my_place, rank, my_row, acummalator)
    print("half_time", my_place, rank, my_row, acummalator)
